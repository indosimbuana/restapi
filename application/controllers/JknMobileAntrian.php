            ...
            if (($dt['nomorkartu'] === NULL || $dt['nomorkartu'] === '') && strlen($dt['nomorkartu']) != 13) {
                ...
                if (($dt['nik'] === NULL || $dt['nik'] === '') && strlen($dt['nik']) != 16) {
                    ...
                    if ($dt['nomorreferensi'] === NULL || $dt['nomorreferensi'] === '') {
                        ...
                        if ($dt['jenisreferensi'] === NULL || $dt['jenisreferensi'] === '' && ($dt['jenisreferensi'] != 1 || $dt['jenisreferensi'] != 2)) {
                            $this->response([
                                'metadata' => [
                                    'code' => 203,
                            ...
                            if ($dt['jenisrequest'] === NULL || $dt['jenisrequest'] === '' && ($dt['jenisrequest'] != 1 || $dt['jenisrequest'] != 2)) {
                                $this->response([
                                    'metadata' => [
                                        'code' => 203,
                                ...
                                if ($dt['polieksekutif'] === NULL || $dt['polieksekutif'] === '' && ($dt['polieksekutif'] !== 1 || $dt['polieksekutif'] !== 0)) {
                                    $this->response([
                                        'metadata' => [
                                            'code' => 203,
